...
class Role extends \Application\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'userRoles');
        }
    ...
    public function setUserRoles(\Doctrine\Common\Collections\ArrayCollection $userRoles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserRoles', array($userRoles));
     ...
     * {@inheritDoc}
     */
    public function addUserRoles(\Doctrine\Common\Collections\ArrayCollection $userRoles)
    {
     ...
     * {@inheritDoc}
     */
    public function removeUserRoles(\Doctrine\Common\Collections\ArrayCollection $userRoles)
    {
