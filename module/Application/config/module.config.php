...
use Application\Security\Authentication\Storage;
...
return array(
    ...
    'service_manager' => array(
        ...
        'factories' => array(
			'Zend\Authentication\AuthenticationService' => function(ServiceLocatorInterface $serviceLocator) {
				$authenticationService = new AuthenticationService();
				
				$storage = new Storage($serviceLocator);
				$adapter = new Adapter($serviceLocator);
